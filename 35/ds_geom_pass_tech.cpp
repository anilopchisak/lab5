...
// defuse - как освещен объект в итоге
// position - насколько далеко нахоходятся части объекта до комеры
// normal - нормали (впуклости и выпуклости)
// tex coord - текстуры

DSGeomPassTech::DSGeomPassTech() : Technique("geometry_pass.glsl")
{   
}
