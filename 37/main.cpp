...
// рассчитываем свет только для небольших необходимых участков
// буфер шаблона используется для ограничения пикселей, для которых будет вызван фрагментный шейдер.
